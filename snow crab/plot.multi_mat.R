...
for (i in 1:length(years)){
   ...
   lines(data$x_mat[ix], data$f_mat[ix], lwd = 1, col = "lightblue")
   ...
   lines(data$x_rec[ix], data$f_rec[ix], lwd = 1, col = "darkolivegreen3")
   
   lines(data$x_rec[ix], obj$report()$eta_rec[ix], lwd = 1, col = "forestgreen")
   lines(data$x_mat[ix], obj$report()$eta_mat[ix], lwd = 1, col = "blue")   
