...
png(file="TMB/SPDE_explanation_pt1.png", width=8, height=4, res=200, units="in")
...
png(file="TMB/SPDE_explanation_pt2.png", width=9, height=3, res=200, units="in")
...
# Plot
png(file="TMB/Matern_explanation.png", width=4, height=4, res=200, units="in")
...
compile( "TMB/autoregressive_grid_V1.cpp" )
dyn.load(dynlib("TMB/autoregressive_grid_V1"))
...
# COmpile
compile( "TMB/matern_SPDE_V1.cpp" )
dyn.load(dynlib("TMB/matern_SPDE_V1"))
